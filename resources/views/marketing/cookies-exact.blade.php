{{-- PIXEL-EXACT port from signed-off https://fansfollowme.com (cookies)
...
<head>
  ...
  <link rel="canonical" href="https://fansfollowme.com/cookies.html">
  <meta name="keywords" content="cookies, policy," />
  <meta name="theme-color" content="#f97316">
  <title>Cookies Policy - FansFollow.me</title>
...
<meta property="og:title" content="Cookies Policy - FansFollow.me">
<meta property="og:description" content="Page Cookies Policy">
<meta property="og:image" content="/public/logo-full-lockup.png">
<meta property="og:url" content="https://fansfollowme.com/cookies.html">
    ...
    <section class="page-shell">
      <div class="container">
        <div class="page-hero">
          ...
          <p>Page Cookies Policy</p>
        </div>
        <div class="page-card">
          <div class="page-content content-p">
            <ol>
              <li>
                <p>Introduction At FansFollow.me, we use cookies and similar technologies to improve your browsing experience and to personalize the content and advertisements that you see on our website. This Cookies Policy explains what cookies are, how we use them, and how you can control them.</p>
              </li>
              <li>
                <p>What are cookies? Cookies are small text files that are stored on your device when you visit a website. They are used to remember your preferences and to track your browsing activity. There are different types of cookies, including session cookies, which are deleted when you close your browser, and persistent cookies, which remain on your device until they expire or you delete them.</p>
              </li>
              <li>
            ...
            <ul>
              <li>Improve the performance of our website: We use cookies to track how our website is used and to identify any errors that may occur.</li>
              <li>Personalize your experience: We use cookies to remember your preferences and to show you content that we believe will be of interest to you.</li>
              <li>Deliver advertisements: We use cookies to deliver advertisements that are relevant to you and your interests.</li>
              <li>Analyze website usage: We use cookies to collect information about how our website is used, such as the pages that are visited and the actions that are taken.</li>
            </ul>

            <ol>
              <li>
                <p>Third-Party Cookies We may also use third-party cookies, which are cookies set by other websites. These cookies may be used to deliver advertisements that are relevant to you and your interests, or to analyze website usage.</p>
              </li>
              <li>
                <p>Controlling cookies You can control the use of cookies on our website by adjusting the settings on your browser. You can also delete cookies that have already been set on your device. However, please be aware that disabling cookies may affect your ability to use certain features of our website.</p>
              </li>
              <li>
                <p>Compliance with UK Law We comply with the UK Privacy and Electronic Communications Regulations (PECR) that requires us to gain your consent before placing certain types of cookies on your device.</p>
              </li>
              <li>
              ...
              <li>
                <p>Contact Us If you have any questions or concerns about this Policy, please contact us at [contact information].</p>
              </li>
            </ol>

            <p>By using FansFollow.me, you acknowledge that you have read and understand this Cookies Policy and agree to be bound by it.</p>
          </div>
        </div>
      </div>
    </section>
