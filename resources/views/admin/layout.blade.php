      ...
      <div class="offcanvas-body px-0 scrollbar">
          <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-start list-sidebar" id="menu">
            ...
            @if (auth()->user()->hasPermission('deposits'))
              ...
              @if (auth()->user()->hasPermission('age_verification'))
              <li class="nav-item">
                  <a href="{{ url('panel/admin/age-verification') }}" class="nav-link text-truncate @if (request()->is('panel/admin/age-verification')) active @endif">
              ...
              @if (auth()->user()->hasPermission('moderation_image_video'))
              <li class="nav-item">
                  <a href="{{ url('panel/admin/moderation-image-video') }}" class="nav-link text-truncate @if (request()->is('panel/admin/moderation-image-video')) active @endif">
                      <i class="bi-shield-check me-2"></i> 

                      {{ __('general.moderation_image_video') }}
                  </a>
              </li><!-- /end list -->
              @endif
            ...
            @endif
              ...
              @if (auth()->user()->hasPermission('stickers'))
              <li class="nav-item">
                  <a href="{{ url('panel/admin/stickers') }}" class="nav-link text-truncate @if (request()->is('panel/admin/stickers')) active @endif">
                      <i class="bi-sticky me-2"></i> {{ __('Stickers') }}
                  </a>
              </li><!-- /end list -->
              @endif

              @if (auth()->user()->hasPermission('giphy'))
              <li class="nav-item">
                  <a href="{{ url('panel/admin/giphy-api') }}" class="nav-link text-truncate @if (request()->is('panel/admin/giphy-api')) active @endif">
                      <i class="bi-filetype-gif me-2"></i> {{ __('Giphy API') }}
                  </a>
              </li><!-- /end list -->
              @endif
            ...
            @if (auth()->user()->hasPermission('countries_states'))
              ...
              @if (auth()->user()->hasPermission('audio_calls'))
              <li class="nav-item">
                  <a href="{{ url('panel/admin/audio-calls') }}" class="nav-link text-truncate @if (request()->is('panel/admin/audio-calls')) active @endif">
                      <i class="bi-telephone me-2"></i> {{ __('general.audio_calls') }}
                  </a>
              </li><!-- /end list -->
              @endif
