...
<div class="content">
	<div class="row">
      ...
      <fieldset class="row mb-4">
        <legend class="col-form-label col-sm-2 pt-0 text-lg-end">{{ __('general.disable_audio') }}</legend>
        <div class="col-sm-10">
          <div class="form-check form-switch form-switch-md">
           <input class="form-check-input" type="checkbox" name="disable_audio" @checked($settings->disable_audio) value="1" role="switch">
         </div>
        </div>
      </fieldset><!-- end row -->

      <fieldset class="row mb-4">
        <legend class="col-form-label col-sm-2 pt-0 text-lg-end">{{ __('general.ppv_only_free_accounts') }}</legend>
        <div class="col-sm-10">
          <div class="form-check form-switch form-switch-md">
           <input class="form-check-input" type="checkbox" name="ppv_only_free_accounts" @checked($settings->ppv_only_free_accounts) value="1" role="switch">
         </div>
        </div>
      </fieldset><!-- end row -->

      <fieldset class="row mb-4">
        <legend class="col-form-label col-sm-2 pt-0 text-lg-end">{{ __('general.allow_vault') }}</legend>
        <div class="col-sm-10">
          <div class="form-check form-switch form-switch-md">
           <input class="form-check-input" type="checkbox" name="allow_vault" @checked($settings->allow_vault) value="1" role="switch">
         </div>
        </div>
      </fieldset><!-- end row -->

      <fieldset class="row mb-4">
        <legend class="col-form-label col-sm-2 pt-0 text-lg-end">{{ __('general.send_welcome_email_new_users') }}</legend>
        <div class="col-sm-10">
          <div class="form-check form-switch form-switch-md">
           <input class="form-check-input" type="checkbox" name="send_welcome_email_new_users" @checked($settings->send_welcome_email_new_users) value="1" role="switch">
         </div>
        </div>
      </fieldset><!-- end row -->
      ...
      <fieldset class="row mb-4">
        <legend class="col-form-label col-sm-2 pt-0 text-lg-end">{{ __('donations.allow_crowdfund_posts') }}</legend>
        <div class="col-sm-10">
          <div class="form-check form-switch form-switch-md">
           <input class="form-check-input" type="checkbox" name="allow_crowdfund" @checked($settings->allow_crowdfund) value="1" role="switch">
         </div>
        </div>
      </fieldset><!-- end row -->
      @endif
      ...
      <fieldset class="row mb-4">
        <legend class="col-form-label col-sm-2 pt-0 text-lg-end">{{ __('general.allow_delete_account') }}</legend>
        <div class="col-sm-10">
          <div class="form-check form-switch form-switch-md">
           <input class="form-check-input" type="checkbox" name="allow_delete_account" @checked($settings->allow_delete_account) value="1" role="switch">
         </div>
        </div>
      </fieldset><!-- end row -->
