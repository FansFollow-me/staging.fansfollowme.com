			...
			<div class="card shadow-custom border-0">
		        ...
		        <div class="row mb-5">
		          ...
		          <div class="col-sm-10">
		            <select name="FILESYSTEM_DRIVER" class="form-select">
						...
						<option @if (config('filesystems.default') == 'r2') selected @endif value="r2">Cloudflare R2</option>
						<option @if (config('filesystems.default') == 'idrive') selected @endif value="idrive">iDrive</option>
		           </select>
		          </div>
		        </div>
				...
				<hr />
						...
						<div class="row mb-3">
						  ...
						  <div class="row mb-3">
							<label class="col-sm-2 col-form-label text-lg-end">Cloudflare R2 Access Key ID</label>
							<div class="col-sm-10">
							  <input value="{{ env('R2_ACCESS_KEY_ID') }}" name="R2_ACCESS_KEY_ID" type="text" class="form-control @error('R2_ACCESS_KEY_ID') is-invalid @endif">
							</div>
						  </div>
		  
								  <div class="row mb-3">
							<label class="col-sm-2 col-form-label text-lg-end">Cloudflare R2 Secret Access Key</label>
							<div class="col-sm-10">
							  <input value="{{ env('R2_SECRET_ACCESS_KEY') }}" name="R2_SECRET_ACCESS_KEY" type="text" class="form-control @error('R2_SECRET_ACCESS_KEY') is-invalid @endif">
							</div>
						  </div>
		  		  
						<div class="row mb-3">
							<label class="col-sm-2 col-form-label text-lg-end">Cloudflare R2 Bucket</label>
							<div class="col-sm-10">
							  <input value="{{ env('R2_BUCKET') }}" name="R2_BUCKET" type="text" class="form-control @error('R2_BUCKET') is-invalid @endif">
							</div>
						  </div>

						  <div class="row mb-3">
							<label class="col-sm-2 col-form-label text-lg-end">Cloudflare R2 Endpoint</label>
							<div class="col-sm-10">
							  <input value="{{ env('R2_ENDPOINT') }}" name="R2_ENDPOINT" type="text" class="form-control @error('R2_ENDPOINT') is-invalid @endif">
							</div>
						  </div>

						  <div class="row mb-3">
							<label class="col-sm-2 col-form-label text-lg-end">Cloudflare R2 Custom URL</label>
							<div class="col-sm-10">
							  <input value="{{ env('R2_URL') }}" name="R2_URL" type="text" class="form-control @error('R2_URL') is-invalid @endif">
							</div>
						  </div>
						  ...
						  <div class="row mb-3">
							<label class="col-sm-2 col-form-label text-lg-end">iDrive Access Key ID</label>
							<div class="col-sm-10">
							  <input value="{{ env('IDRIVE_KEY') }}" name="IDRIVE_KEY" type="text" class="form-control @error('IDRIVE_KEY') is-invalid @endif">
							</div>
						  </div>
		  
						<div class="row mb-3">
							<label class="col-sm-2 col-form-label text-lg-end">iDrive Secret Access Key</label>
							<div class="col-sm-10">
							  <input value="{{ env('IDRIVE_SECRET') }}" name="IDRIVE_SECRET" type="text" class="form-control @error('IDRIVE_SECRET') is-invalid @endif">
							</div>
						  </div>
		  		  
						<div class="row mb-3">
							<label class="col-sm-2 col-form-label text-lg-end">iDrive Region</label>
							<div class="col-sm-10">
							  <input value="{{ env('IDRIVE_REGION') }}" name="IDRIVE_REGION" type="text" class="form-control @error('IDRIVE_REGION') is-invalid @endif">
							</div>
						  </div>
		  
						<div class="row mb-3">
							<label class="col-sm-2 col-form-label text-lg-end">iDrive Bucket</label>
							<div class="col-sm-10">
							  <input value="{{ env('IDRIVE_BUCKET') }}" name="IDRIVE_BUCKET" type="text" class="form-control @error('IDRIVE_BUCKET') is-invalid @endif">
							</div>
						  </div>

						  	 <div class="row mb-3">
							<label class="col-sm-2 col-form-label text-lg-end">iDrive Endpoint</label>
							<div class="col-sm-10">
							  <input value="{{ env('IDRIVE_ENDPOINT') }}" name="IDRIVE_ENDPOINT" type="text" class="form-control @error('IDRIVE_ENDPOINT') is-invalid @endif" placeholder="https://bucket.0000.la1.idrivee2-90.com">
							</div>
						  </div>
